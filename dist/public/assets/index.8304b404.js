...
const scriptRel = 'modulepreload';const assetsURL = function(dep) { return "/heatmap/"+dep };const seen = {};const __vitePreload = function preload(baseModule, deps, importerUrl) {
    // @ts-ignore
...
const _tmpl$ = /*#__PURE__*/template(`<div><div><p id="error-message"></p><button id="reset-errors">Clear errors and retry</button><pre></pre></div></div>`);
...
export { $PROXY as $, For as F, ServerContext as S, Title as T, getNextMarker as a, $TRACK as b, createComponent as c, getListener as d, batch as e, createSignal as f, getNextElement as g, delegateEvents as h, insert as i, onCleanup as o, template as t, useContext as u };
